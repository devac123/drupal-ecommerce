...
/* themes/subtheme/templates/navigation/menu--main--mainnavigation.html.twig */
class __TwigTemplate_19c37740896cde43ad7cb664c92c17e95da887ee80b962626fdf325d71a9c1e5 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav navbar-nav footer-navigation-menu"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "url", [], "any", false, false, true, 54), "toString", [], "method", false, false, true, 54), 54, $this->source)))];
  ...
  ";
    ...
    {
        return "themes/subtheme/templates/navigation/menu--main--mainnavigation.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('nav navbar-nav footer-navigation-menu') }}>
    {% else %}
  ...
  {% endif %}
{% endmacro %}
", "themes/subtheme/templates/navigation/menu--main--mainnavigation.html.twig", "C:\\xampp\\htdocs\\ecommerce\\web\\themes\\subtheme\\templates\\navigation\\menu--main--mainnavigation.html.twig");
    }
